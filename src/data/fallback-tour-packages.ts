...
export const fallbackTourPackages: EnrichedTourPackage[] = [
  {
    ...
    shortDescription:
      'Tea plantations, cool climates, and elevated climbs across the Central Highlands.',
    itinerary: [
      {
        day: 1,
        title: 'Kandy heritage warm-up',
        description:
          'Arrival, bike fitting, and an evening shakedown ride around Kandy Lake and the Temple of the Tooth.',
        distance: '18 km',
        meals: 'Dinner',
      },
      {
        ...
        description:
          'Ride from Kandy to Hatton via winding plantation roads with tea tasting and planter high tea.',
        distance: '62 km',
      ...
      },
      {
        ...
        description:
          'Sunrise hike option followed by a gravity-fed ride through pine forests and reservoirs.',
        distance: '48 km',
      ...
      },
      {
        ...
        description:
          'Challenge day with crisp-air climbs, strawberry farms, and a hot chocolate reward at Pedro Estate.',
        distance: '55 km',
      ...
      },
      {
        ...
        description:
          'Ride parallel to the iconic train line, catching glimpses of Nine Arch Bridge before descending to Ella.',
        distance: '58 km',
      },
    ],
    whatToBring: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, a limited number of pedal-assist bikes can be reserved in advance for an additional USD 35 per day.',
      },
    ],
    reviews: [
      {
    ...
    sustainability: {
      ...
      communityImpact:
        'Tea estate homestays and women-run spice gardens share 15% of tour profits.',
      supportVehicle: true,
    },
    duration: 5,
    ...
    maxGroupSize: 12,
    includedServices: [
      'Premium Trek or Giant hardtail',
      'Professional ride leaders',
      'Support van + mechanic',
      '4 nights boutique lodging',
      'All breakfasts & selected meals',
    ],
    excludedServices: [
    ...
    highlights: [
      'Tea factory cupping',
      'Highland rail trail',
      'Adam’s Peak sunrise option',
      'Ella canyon descent',
    ],
    images: [
      '/images/hill-country-1.jpg',
      '/images/hill-country-2.jpg',
      '/images/hill-country-3.jpg',
    ],
    ...
    metaDescription:
      'Five-day elevated ride through Sri Lanka’s Central Highlands with tea estates, waterfalls, and boutique stays.',
  ...
  },
  {
    ...
    shortDescription:
      'Laid-back coastal riding with seafood feasts, mangrove detours, and boutique beach stays.',
    itinerary: [
      {
        day: 1,
        title: 'Galle ramparts sunset spin',
        description: 'Arrival spin atop UNESCO-listed fort walls before seafood welcome dinner.',
        distance: '12 km',
      },
      {
        day: 2,
        title: 'Lighthouse to lagoon',
        description: 'Boardwalk ride past Koggala Lake spice islands with cinnamon tasting.',
        distance: '38 km',
      },
      {
        day: 3,
        title: 'Stilt fisherman encounter',
        description:
          'Coastal gravel segments with surf break coffee stops and optional SUP session.',
        distance: '42 km',
      },
      {
        day: 4,
        title: 'Tangalle turtle patrol',
        description: 'Dawn ride to turtle conservation centre then snorkel at Hiriketiya Bay.',
        distance: '36 km',
      },
    ],
    whatToBring: [
      'Breathable sun sleeves',
      'Reef-safe sunscreen',
      'Quick-dry swimwear',
      'Sandals for beach stops',
    ...
    faqs: [
      {
        ...
        answer:
          'Yes, we welcome confident teens 14+ and can arrange e-bikes for mixed ability groups.',
      },
      {
        question: 'Do we ride on highways?',
        answer:
          'Routes prioritise coastal B-roads and boardwalks; busy crossings are van-supported.',
      },
    ],
    reviews: [
      {
        author: 'Tessa & Mark',
        role: 'Couple from Sydney',
        rating: 5,
        date: 'August 2024',
        content:
          'Every day balanced relaxed riding with ocean dips. The guides had endless local stories.',
      },
    ],
    supportContacts: [
      {
        label: 'Trip designer',
        value: 'coastal@cycleparadise.lk',
        href: 'mailto:coastal@cycleparadise.lk',
      },
    ...
    maxGroupSize: 16,
    includedServices: [
      'Beach cruiser or gravel bike',
      'Ride leaders + lifeguard escort',
      '3 nights boutique hotels',
      'Breakfast + seafood dinners',
      'Helmet, lights, and GPS navigation',
    ],
    excludedServices: ['Lunches', 'Alcoholic drinks', 'Optional SUP / snorkel rentals'],
    highlights: [
      'Stilt fishing workshops',
      'Mangrove kayaking',
      'Turtle conservation',
      'Golden-hour fort walks',
    ],
    images: ['/images/coastal-1.jpg', '/images/coastal-2.jpg', '/images/coastal-3.jpg'],
    mediaGallery: makeGallery(
      ['/images/coastal-1.jpg', '/images/coastal-2.jpg', '/images/coastal-3.jpg'],
    ...
    metaDescription:
      'Sun-splashed four-day ride hugging Sri Lanka’s south coast with seafood feasts and lagoon detours.',
  ...
  },
  {
    ...
    shortDescription:
      'UNESCO wonders, rural rice paddies, and sunset summit hikes in North Central Sri Lanka.',
    itinerary: [
      {
        day: 1,
        title: 'Anuradhapura heritage loop',
        description: 'Ride among stupas and sacred bodhi trees with a resident archaeologist.',
        distance: '28 km',
      },
      {
        day: 2,
        title: 'Mihintale ridge challenge',
        description: 'Switchback climb rewarded with 360° views and sunset meditation.',
        distance: '34 km',
      },
      {
        day: 3,
        title: 'Sigiriya double summit',
        description: 'Pedal to Sigiriya Rock and optional Pidurangala sunset scramble.',
        distance: '40 km',
      },
      {
        day: 4,
        title: 'Rural reservoirs & elephants',
        description: 'Gravel ride skirting Minneriya National Park with jeep safari add-on.',
        distance: '52 km',
      },
      {
        day: 5,
        title: 'Polonnaruwa royal mile',
        description: 'Time-trial between palace ruins before farewell curry feast.',
        distance: '30 km',
      },
    ],
    whatToBring: [
      'Lightweight scarf for temple visits',
      'Bug spray for dusk rides',
      'Cash for roadside fruit stalls',
      'Head torch for dawn hikes',
    ],
    faqs: [
      {
        question: 'Are temple entry fees included?',
        answer: 'Yes, all UNESCO site permits and guiding fees are covered.',
      },
      {
        question: 'Will we see wildlife?',
        answer:
          'Wild elephant sightings are common on Day 4; spotters and radios keep everyone safe.',
      },
    ],
    reviews: [
      {
        ...
        date: 'July 2024',
        content:
          'Combines proper riding with incredible storytelling. I filled an entire sketchbook.',
      },
    ],
    supportContacts: [
    ...
    includedServices: [
      ...
      'Support jeep + mechanic',
      'Safari jeep (shared)',
      'Breakfast + most lunches',
    ],
    ...
    mediaGallery: makeGallery(
      ['/images/cultural-1.jpg', '/images/cultural-2.jpg', '/images/cultural-3.jpg'],
      'Cultural Triangle Expedition'
    ),
    ...
    metaDescription:
      'Five-day history-rich ride linking Sigiriya, Anuradhapura, and Polonnaruwa with expert storytellers.',
...
export const getRelatedFallbackTourPackages = (
  slug: string,
  region?: string,
  limit: number = 3
) => {
